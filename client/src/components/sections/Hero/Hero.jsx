      ...
      <div className="hero-image-container h-full w-full m-0 p-0">
        <div className="hero-container h-full w-full m-0 p-0 flex flex-col">
          ...
          <div className="name-and-titles-container w-full flex-1 flex items-center justify-center">
            <div className="name-and-titles text-center max-w-6xl mx-auto px-4">
              <p className="greeting text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl m-0 mb-6 text-white font-light">
                Hi! I'm
              </p>
              <div className="jay-container relative inline-block mb-12">
                ...
                <h1 className="jay text-8xl sm:text-9xl md:text-10xl lg:text-11xl xl:text-12xl m-0 p-0 leading-none relative z-10 text-white font-bold">
                  JAY.
                </h1>
              </div>
              <div className="name-and-roles space-y-4">
                <span className="name text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl m-0 text-white font-medium block">
                ...
                <p className="roles text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl m-0 text-white font-light">
