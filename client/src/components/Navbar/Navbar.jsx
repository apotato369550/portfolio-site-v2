      ...
      <nav id="navbar" className="hidden lg:block w-full">
        <ul className="flex justify-between items-center mx-16 lg:mx-20 xl:mx-24 mt-8 lg:mt-12 xl:mt-16 list-none p-0">
          <li className="navbar-item">
            <a
              href="#hero"
              className="text-white no-underline text-base lg:text-lg xl:text-xl font-light hover:text-cyan-300 transition-colors duration-300 relative group"
            >
              Home
          ...
          <li className="navbar-item">
            ...
            >
              What I'm Working On
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-cyan-300 transition-colors duration-300 group-hover:w-full"></span>
            </a>
          </li>
          <li className="navbar-item">
            <a
